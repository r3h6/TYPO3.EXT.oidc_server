...
CREATE TABLE `fe_users` (
  ...
  `tx_oidcserver_nickname` varchar(255) NOT NULL DEFAULT '',
  `tx_oidcserver_gender` varchar(255) NOT NULL DEFAULT '',
  `tx_oidcserver_birthdate` date DEFAULT NULL,
  `tx_oidcserver_locale` varchar(255) NOT NULL DEFAULT '',
  `tx_oidcserver_zoneinfo` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`uid`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `fe_users` VALUES (1,3,1718489888,1717089603,0,0,0,0,'','Tx_OidcServer_User',1717616096,'jondoe','$argon2i$v=19$m=65536,t=16,p=1$Q05aeEtUM29EYll3Y0s3Vw$pWaw11UNerbj4hppKdd3AMN7onwdHBIsp2yRBlJVA84','1','','','','','','','','',NULL,'','','','','','',0,'',1717617044,NULL,'','','','',NULL,'','');
DROP TABLE IF EXISTS `fe_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fe_users` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `sys_news` VALUES (1,0,1724776092,1724776092,0,0,0,0,'Login','Username: \"admin\", Password: \"Password1!\"');
